...
These map very closely to the layers defined in the EOSC Declaration, of Institutional, Executive, and Advisory). In this model, the Advisory Layer from the declaration would involve the engaging citizens skills to determine the scientific and technical needs of the users. The term “Advisory” is meant, in this context, to concern engaging with all stakeholders. It is important that stakeholders are, and feel that they are, peers in the decision-making process. They should perform a role that is both advisory and steering. For this reason, we have used the word “steering” in this document rather than just “advisory”.  It should be noted that there are a wide variety of definitions of “Steering Board” and “Steering Committee” from being the final decision maker or arbitrator to providing strong guidance and direction. As regards the governance framework, the definition of the Steering layer is closer to the latter – it provides strong guidance and direction (not just advisory) to the Strategic layer, but the Strategic layer is the final decision-making body.  
